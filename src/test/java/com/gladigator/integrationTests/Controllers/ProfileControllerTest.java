...
public class ProfileControllerTest {
	...
	mockMvc.perform(get("/profile").with(anonymous())).andDo(print()).andExpect(status().is(302))
    ...
    @Transactional // Rozszerza transakcje na metode testowa. Dzieki temu zmiany dokonane w
		   // metodzie testowej sa domyslnie rollback'owane.
    // Alternatywa dla DiritiesContext np. w UserDaoTest - nie bedzie trzeba od nowa
    // ladowac kontekstow, bo zmiany nie sa commitowane i konteksty pozostaja czyste
    @Test
