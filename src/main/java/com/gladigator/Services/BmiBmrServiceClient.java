...
public class BmiBmrServiceClient extends WebServiceGatewaySupport {
	...
	private static final Logger LOG = LoggerFactory.getLogger(BmiBmrServiceClient.class);
	...
	public CalculateBMIResponse callBmiService(CalculateBMIRequest request) {
		...
		JAXBElement<CalculateBMIResponse> wrappedResponse = (JAXBElement<CalculateBMIResponse>) getWebServiceTemplate()
				.marshalSendAndReceive("http://localhost:8090/bmibmrcalculatorws/bmibmrcalculator", wrappedRequest);
	...
	public CalculateBMRResponse callBmrService(CalculateBMRRequest request) {
		...
		JAXBElement<CalculateBMRResponse> wrappedResponse = (JAXBElement<CalculateBMRResponse>) getWebServiceTemplate()
				.marshalSendAndReceive("http://localhost:8090/bmibmrcalculatorws/bmibmrcalculator", wrappedRequest);
